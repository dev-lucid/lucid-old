...
update users set created_on = strftime('%s','now');
...
insert into addresses (org_id,name,street_1,street_2,city,region_id,postal_code,phone_number_1,phone_number_2)
    values 
    (1, 'Admin office','100 Alpha St','Suite A','Atlanta','US-AL','30303-0001','(111) 111-1111','(111) 111-1111 ext 111'),
    (1, 'Adjunct office','100 Aleph Ave','Apt A','Atlanta','US-AL','30301-0001','(111) 111-2222','(111) 111-2222 ext 111'),
    (2, 'Base Camp','200 Base St','Suite B','Birmingham','GB-BIR','B74','(020) 2222 2222','(020) 2222 2222 ext 222'),
    (2, 'Beta Site','210 Beta Ave','Apt B','Bradford','GB-BRD','B71','(020) 2222 2444','(020) 2222 2444 ext 225'),
    (3, 'Central Command','300 Canada str','Suite C','Calgary','CA-AB','T20','(333) 333 3333','(333) 333 3333 ext 333'),
    (4, 'Downtown Branch','400 Denmark ave','Suite D','Duluth','US-MN','56666','(444) 444-4444','(444) 444-4444 ext 444'),
    (5, 'Eastern Office','500 Excelsior ave','Suite E','East Chicago','US-IL','61666','(555) 555-5555','(555) 555-5555 ext 555');
