...
lucid.handleResponse=function(response){
    ...
    try{
        ...
        */
        ...
        console.log('Exception occured when trying to handle response from server: ');
        console.log(e);
    }
    try{
...
lucid.redirect=function(newUrl){
    var newUrl = 'index.html#!' + (new String(newUrl));
    console.log('lucid.redirect:: new url is: '+newUrl);
...
lucid.handleHashchange=function(){
    ...
    */
    ...
    for(var i=1;i<urlParts.length;i+=2){
        urlData[urlParts[i]] = urlParts[i + 1];
    }
